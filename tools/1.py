...
seg, _ = LoadImage(image_only=False, reader='PILReader')('/root/autodl-tmp/vesuvius-challenge-ink-detection/train/1/surface_volume/64.tif')
...
# mydict = {'inklabels':['/root/autodl-tmp/vesuvius-challenge-ink-detection/train/1/inklabels.png']}
mydict = {"image":files,'label': ['/root/autodl-tmp/vesuvius-challenge-ink-detection/train/3/mask.png']}

# print(type(datalist[0]))
# print(type(mydict))
# print(mydict==datalist[0])
# print(mydict["image"]==datalist[0]["image"])
# print(mydict["label"]==datalist[0]["label"])
# print(mydict["inklabels"]==datalist[0]["inklabels"])
print("==============================================")
print(datalist[0])
print("==============================================")
print(mydict)
...
print("====================11========================")
img = apply_transform(train_transform, datalist[0])
print("====================22========================")
print(img)